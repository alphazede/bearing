...
export function canonicalizeFitOwnerAnswer(answer, repositoryRoot) {
    ...
    if (absolutePlanDirectory !== undefined)
        return { ok: true, answer: absolutePlanDirectory };
    if (absolutePath(answer) || /^[A-Za-z]:/.test(answer))
        return {
            ok: false,
